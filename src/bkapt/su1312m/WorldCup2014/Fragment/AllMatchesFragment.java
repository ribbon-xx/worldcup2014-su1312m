...
import bkapt.su1312m.WorldCup2014.Fragment.ToDayTVFragment.Getcontacts;
...
public class AllMatchesFragment extends Fragment {
	...
	private static String url = "http://cup.tin9x.vn/lichthidau/get_all_match.php";
	private Matches matches;
	private TransparentProgressDialog pDialog;
	private ListView lvAllmatch;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.allmatches, container, false);
		InitView(rootView);
		return rootView;
	}
	public void InitView(View v) {
		lvAllmatch = (ListView) v.findViewById(R.id.lvAllmatch);
	...
	class Getcontacts extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			lvAllmatch.setAdapter(adapter);
			if (adapter.getCount() < 1) {
				Toast.makeText(getActivity(), "Không Có Dữ Liệu", 1)
						.show();
			}
